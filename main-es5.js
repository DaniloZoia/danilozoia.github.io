...
var AggiornamentoArchivioComponent = /** @class */ (function () {
    function AggiornamentoArchivioComponent(computerService) {
        this.computerService = computerService;
    }
    AggiornamentoArchivioComponent.prototype.ngOnInit = function () {
    ...
    AggiornamentoArchivioComponent.prototype.aggiornaComputers = function () {
        var _this = this;
        this.computerService.updateComputers(this.formComputers.value)
            .subscribe(function (res) {
            _this.computerService.loadComputers();
            _this.formComputers.reset();
        });
    };
    AggiornamentoArchivioComponent.ctorParameters = function () { return [
    ...
    return AggiornamentoArchivioComponent;
}());
...
var ArchivioComponent = /** @class */ (function () {
    function ArchivioComponent(computerService) {
        this.computerService = computerService;
        computerService.loadComputers();
    }
    Object.defineProperty(ArchivioComponent.prototype, "computer", {
        get: function () {
    ...
    Object.defineProperty(ArchivioComponent.prototype, "marche", {
        get: function () {
    ...
    ArchivioComponent.prototype.selezionaMarca = function (marca) {
        this.marcaSelezionata = marca;
    };
    ArchivioComponent.prototype.ngOnInit = function () {
    };
    ArchivioComponent.ctorParameters = function () { return [
...
var GestioneComponent = /** @class */ (function () {
    function GestioneComponent(computerService) {
        this.computerService = computerService;
    }
    GestioneComponent.prototype.ngOnInit = function () {
        this.computerService.loadComputers();
        this.formComputers = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormGroup"]({
            marca: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('', [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]),
            nome: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('', [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]),
    ...
    GestioneComponent.prototype.salvaComputers = function () {
        var _this = this;
    ...
    GestioneComponent.ctorParameters = function () { return [
        { type: src_app_services_computer_service__WEBPACK_IMPORTED_MODULE_3__["ComputerService"] }
    ]; };
...
var Computer = /** @class */ (function () {
    function Computer(id, marca, nome, os, hd, ram, cpu, seriale, attivo, // boolean
    ...
    Computer.ctorParameters = function () { return [
        { type: Number },
        { type: String },
        { type: String },
        { type: String },
...
var NavmenuComponent = /** @class */ (function () {
    ...
    NavmenuComponent.prototype.toggleNavmenu = function () {
...
var ComputerService = /** @class */ (function () {
    function ComputerService(httpClient) {
    ...
    ComputerService.prototype.loadComputers = function () {
        var _this = this;
        var observable = this.httpClient.get('computer'); // ('http://localhost:3000/computers')
        observable.subscribe(function (response) {
            _this._COMPUTERS = response;
            // this.computer_id = params ['id'];
        }, function (error) { console.log(error); });
    };
    ComputerService.prototype.getComputer = function (marca) {
        if (marca) {
            return this._COMPUTERS.filter(function (com) { return com.marca === marca; });
        }
        else {
            return this._COMPUTERS;
        }
    };
    ComputerService.prototype.getMarche = function () {
        return this._COMPUTERS
            .map(function (com) { return com.marca; })
            .filter(function (marca, index, array) { return array.indexOf(marca) === index; })
            .sort();
    };
    ComputerService.prototype.createComputers = function (computers) {
        return this.httpClient.post('http://localhost:3000/computers', computers);
    };
    ComputerService.prototype.updateComputers = function (computers) {
